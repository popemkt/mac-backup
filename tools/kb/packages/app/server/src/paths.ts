 ...
 * relative to this module under `packages/app/server/src/`.
 */
const KB_PKG_ROOT =
...
/** Source root of the `@kb/ui` package (`$KB_PKG_ROOT/packages/app/ui`). */
export const UI_ROOT = join(KB_PKG_ROOT, "packages", "app", "ui");
