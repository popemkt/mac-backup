...
export function GraphSelectionCard({
  ...
  return (
    <div
      className="kb-surface-enter absolute bottom-4 right-4 z-30 flex max-w-xs flex-col gap-1.5 rounded-lg border border-foreground/10 bg-popover/95 p-3 shadow-overlay backdrop-blur-sm"
