...
| Graph database engines & query paradigms | **GDB-Engines** (https://gdb-engines.com/) *(reference/inspiration)* | Comparative catalog of 145+ graph database engines (LPG, RDF, multi-model, embedded), query languages (Cypher, Gremlin, DQL, SPARQL, TypeQL), and architecture traits for evaluating storage/query backends |
