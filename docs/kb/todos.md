...
- canvas.test.ts calls mkdtemp inside packages/runtime/tests, so an aborted run leaves kb-canvas-* directories in the tree (seen in the t2 worktree 2026-09-04); use os.tmpdir() or a try/finally rm
